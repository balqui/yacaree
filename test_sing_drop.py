...
def test_sd(rul, miner):
    ...
    for it in rul.an:
        ...
        if sub_cn_supp * IFace.hpar.absoluteboost > sub_an_supp:
            ...
            return False
        elif sub_cn_supp / sub_an_supp >= altconf:
            altconf = sub_cn_supp / sub_an_supp
            print(" ...... sd same or more conf, take out", it, altconf)
    if altconf > 0:
        print(" .... std:", rul.cboo, "sd:", 1/altconf)
    if abs(rul.cboo - 1/altconf) < 0.001:
        return True
